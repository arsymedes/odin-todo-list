...
const content = (() => {
  ...
  function displayItems() {
    ...
    let project = processor.getProject()
  ...
  function addForm() {
    ...
    document.querySelector("#my-form").addEventListener("submit", event => {
      ...
      storage.addItem(document.getElementById("title").value, document.getElementById("desc").value, document.getElementById("date").value, document.querySelector('input[name="priority"]:checked').value, storage.getCurrentProject());
      displayItems();
      document.querySelector(".popup").remove()
    })
  ...
  function editForm(el) {
    ...
    document.querySelector("#my-form").addEventListener("submit", event => {
      event.preventDefault();
      storage.editItem(index, document.getElementById("title").value, document.getElementById("desc").value, document.getElementById("date").value, document.querySelector('input[name="priority"]:checked').value, projectName);
      displayItems();
      document.querySelector(".popup").remove()
    })
